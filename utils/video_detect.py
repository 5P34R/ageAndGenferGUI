...
faceCascade = cv2.CascadeClassifier('utils/style.xml')
...
def load_caffe_models():
    age_net = cv2.dnn.readNetFromCaffe('utils/deploy_age.prototxt', 'utils/age_net.caffemodel')
    gender_net = cv2.dnn.readNetFromCaffe('utils/deploy_gender.prototxt', 'utils/gender_net.caffemodel')
